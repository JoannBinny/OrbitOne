...
def seed():
    ...
    locations = [
        ...
        models.Location(
            organization_id=org.id, name="Innovation Hall", capacity=150,
            has_computers=False, has_projector=True, has_microphone=True,
        ),
        models.Location(
            organization_id=org.id, name="Main Auditorium", capacity=300,
            has_computers=False, has_projector=True, has_microphone=True,
        ),

        # Computer labs — for hands-on technical sessions
        models.Location(
            organization_id=org.id, name="Computer Lab 2", capacity=60,
            has_computers=True, has_projector=True,
        ),
        models.Location(
            organization_id=org.id, name="Computer Lab 3", capacity=45,
            has_computers=True, has_projector=True,
        ),

        # Classrooms — general teaching spaces
        models.Location(
            organization_id=org.id, name="Seminar Room 3", capacity=40,
            has_projector=True, has_whiteboard=True,
        ),
        models.Location(
            organization_id=org.id, name="Classroom 101", capacity=35,
            has_projector=True, has_whiteboard=True,
        ),
        models.Location(
            organization_id=org.id, name="Classroom 204", capacity=50,
            has_projector=True, has_whiteboard=True,
        ),

        # Meeting rooms — small, discussion-focused
        models.Location(
            organization_id=org.id, name="Meeting Room A", capacity=10,
            has_projector=True, has_whiteboard=True,
        ),
        models.Location(
            organization_id=org.id, name="Meeting Room B", capacity=15,
            has_projector=True, has_whiteboard=True, has_microphone=True,
        ),
        models.Location(
            organization_id=org.id, name="Boardroom", capacity=12,
            has_projector=True, has_microphone=True,
        ),

        # Outdoor areas — no built-in equipment, but real bookable spaces
        models.Location(
            organization_id=org.id, name="Central Lawn", capacity=200,
            has_computers=False, has_projector=False, has_microphone=False,
        ),
        models.Location(
            organization_id=org.id, name="Amphitheater", capacity=100,
